...
import com.meteocontrol.client.models.DeviceMeasurement;
...
public class Measurements extends SubEndpoint {
    ...
    public DeviceMeasurement get(MeasurementsCriteria criteria) throws IOException {
        ...
        return mapper.readValue(rootNode.get("data").toString(), DeviceMeasurement.class);
    }
}
